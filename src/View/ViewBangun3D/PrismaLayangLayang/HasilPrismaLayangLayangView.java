...
public class HasilPrismaLayangLayangView extends JFrame {

    public HasilPrismaLayangLayangView(PrismaLayangLayang prisma) {
        initComponents(prisma);
        setLocationRelativeTo(null);
        setTitle("Hasil Kalkulasi Prisma Layang-Layang");
    }

    private void initComponents(PrismaLayangLayang prisma) {
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setSize(500, 450);
        setLayout(null);

        JLabel jLabelTitle = new JLabel("HASIL PRISMA LAYANG-LAYANG", SwingConstants.CENTER);
        ...
        JTextField jTextFieldVolume = new JTextField(String.format("%.2f", prisma.getVolumePrismaLayangLayang())); //
        ...
        JTextField jTextFieldLuas = new JTextField(String.format("%.2f", prisma.getLuasPermukaanPrismaLayangLayang())); //
        ...
        jButtonEdit.addActionListener(e -> {
            dispose();
            new PrismaLayangLayangView(prisma).setVisible(true);
        });
