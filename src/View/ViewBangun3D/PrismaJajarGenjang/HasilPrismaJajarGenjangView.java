...
public class HasilPrismaJajarGenjangView extends JFrame {

    public HasilPrismaJajarGenjangView(PrismaJajarGenjang prisma) {
        initComponents(prisma);
        setLocationRelativeTo(null);
        setTitle("Hasil Kalkulasi Prisma Jajar Genjang");
    }

    private void initComponents(PrismaJajarGenjang prisma) {
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setSize(500, 450);
        setLayout(null);

        JLabel jLabelTitle = new JLabel("HASIL PRISMA JAJAR GENJANG", SwingConstants.CENTER);
        ...
        JTextField jTextFieldVolume = new JTextField(String.format("%.2f", prisma.getVolumePrismaJajarGenjang())); //
        ...
        JTextField jTextFieldLuas = new JTextField(String.format("%.2f", prisma.getLuasPermukaanPrismaJajarGenjang())); //
        ...
        jButtonEdit.addActionListener(e -> {
            dispose();
            new PrismaJajarGenjangView(prisma).setVisible(true);
        });
