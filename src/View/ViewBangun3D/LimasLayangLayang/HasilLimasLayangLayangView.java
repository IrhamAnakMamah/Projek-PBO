...
public class HasilLimasLayangLayangView extends JFrame {

    public HasilLimasLayangLayangView(LimasLayangLayang limas) {
        initComponents(limas);
        setLocationRelativeTo(null);
        setTitle("Hasil Kalkulasi Limas Layang-Layang");
    }

    private void initComponents(LimasLayangLayang limas) {
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setSize(500, 450);
        setLayout(null);

        JLabel jLabelTitle = new JLabel("HASIL LIMAS LAYANG-LAYANG", SwingConstants.CENTER);
        ...
        JTextField jTextFieldVolume = new JTextField(String.format("%.2f", limas.getVolumeLimasLayangLayang())); //
        ...
        JTextField jTextFieldLuas = new JTextField(String.format("%.2f", limas.getLuasPermukaanLimasLayangLayang())); //
        ...
        jButtonEdit.addActionListener(e -> {
            dispose();
            new LimasLayangLayangView(limas).setVisible(true);
        });
